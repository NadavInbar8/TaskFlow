					...
					<main className='details-modal-content'>
						...
						<ul>
							<li
								...
								<div style={{color: 'black', backgroundColor: 'darkcyan'}} className='user-logo'>
							...
							{usersMinusLoggedInUser.map((user, idx) => {
								return (
									<li onClick={() => addUser(user)} key={idx}>
										<div style={{backgroundColor: 'red'}} className='user-logo'>
											{user.initials}
										</div>
										{user.fullName}
									</li>
...
export function Labels({addLabel, toggleModal, board, updateLabelsList}) {
	...
	return (
		<div className=' labels details-modal'>
			<section className='details-modal-top'>
				<img className='arrowleft' onClick={() => setEditMode(!editMode)} src={arrowleft} />
				<span> Labels</span>
			...
			{editMode && (
				<div className='details-modal-content'>
					...
					<div className='edit-labels'>
						{labels.map((label, idx) => {
							return (
								<div onClick={() => markChosen(label)} className={'edit-label label-' + label.color} key={idx}></div>
							);
						})}
					</div>
	...
	render() {
		return (
			<div className='details-modal Dates'>
				<section className='details-modal-top'>
					<span>Date</span>
					<img onCLick={() => this.props.toggleModal('dates')} src={xsvg} alt='' />
				</section>
				<section className='details-modal-content'>
