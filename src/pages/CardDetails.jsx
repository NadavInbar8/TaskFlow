...
import {Members, Labels, Checklist, Dates, Attachment, Cover, Move} from '../cmps/detailsModals/modals.jsx';
...
export const CardDetails = () => {
	...
	function addComment(ev) {
		ev.preventDefault();
		const currCard = card;
		currCard.comments ? currCard.comments.push(comment) : (currCard.comments = [comment]);
		setCard(currCard);
		updateCard();
                ...
                {console.log(card.cover.cover)} */}
											...
											<section className='users-section'>
												...
												<section className='users-details-section'>
													{card.users.map((user) => {
														...
														return (
															<div style={{backgroundColor: background}} className='user-details-preview'>
																{user.initials}
															</div>
														);
													})}
												...
												return (
													<div key={idx} className='card-details-link'>
														...
														<section className='link-description'>
															<span className='name bold'>{attachment.name}</span>
															<h4>
																Added
                    ...
                    <div className='checklist'>
                      ...
                      <button>Add an item</button>
									...
									<form className='gap-right add-comment-form' onSubmit={addComment} action=''>
										<label>
											<br />
											<input
												value={comment.txt}
