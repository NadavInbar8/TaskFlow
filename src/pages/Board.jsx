		...
		<section className='flex-column h100'>
			...
			{board ? (
				<>
					...
					/>
					<div className='board flex' onClick={(event) => event.stopPropagation()}>
						{board.groups
							? board.groups.map((list) => {
									return (
										<div key={list.id} className='board-list flex-column'>
											<h3>{list.title}</h3>
											<img src={dotdotdot} className='list-menu' alt='list menu' />
														...
														<li key={card.id} className='board-card flex-column'>
															{card.cover ? (
																<div
																	...
																	style={card.cover.type == 'color' ? {backgroundColor: card.cover.cover} : null}>
																	{card.cover.type == 'img' ? (
																		<img src={card.cover.cover} className='card-img-cover' />
																	) : null}
																</div>
															) : null}
															<div className='board-card-details'>
																...
																<div className='card-title flex'>
																	...
																	<div className='board-card-edit-btn ' onClick={() => openEditModal(card)}>
																...
																<div className='card-options flex'>
																	{card.date ? (
																		<div
																			...
																			style={
																				!card.date.overDue ? {backgroundColor: '#61BD4F'} : {backgroundColor: '#EB5A46'}
																			}>
																			<img src={dueDate} />
																			{card.date.date}
																		</div>
