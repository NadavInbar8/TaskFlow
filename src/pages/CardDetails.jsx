...
export const CardDetails = () => {
  ...
  function deleteCard() {
    ...
    let activity = `${loggedInUser.fullName} deleted a card at board-${
      board.title
    } at ${getNiceDate()}`;
  ...
  function addComment(ev) {
    ...
    let activity = `${loggedInUser.fullName} added a comment to card-"${
      card.title
    }" at ${getNiceDate()}`;
    updateCard(activity);
  ...
  function deleteComment(idx) {
    ...
    let activity = `${loggedInUser.fullName} deleted a comment at card-"${
      card.title
    }" at ${getNiceDate()}`;
    updateCard(activity);
  }
  ...
  function addDate(date) {
    ...
    setCard(currCard);
    socket.emit('updateCard', card);
    let activity = `${loggedInUser.fullName} added a date to card-"${
      card.title
    }" at ${getNiceDate()}`;
    updateCard(activity);
  }
  ...
  function toggleDateComplete() {
    ...
    setCard(currCard);
    socket.emit('updateCard', card);
    let activity = `${loggedInUser.fullName} marked "${
      card.title
    }" date at ${getNiceDate()}`;
    updateCard(activity);
  }
  ...
  function addLabel(label) {
    ...
    setCard(currCard);
    socket.emit('updateCard', card);
    let activity = `${loggedInUser.fullName} added a label at card-"${
      card.title
    }" at ${getNiceDate()}`;
    updateCard(activity);
  }
  ...
  function deleteLabel(idx) {
    ...
    setCard(currCard);
    let activity = `${loggedInUser.fullName} deleted a label at card-"${
      card.title
    }" at ${getNiceDate()}`;
    console.log(currCard);
    updateCard(activity);
  ...
  function updateLabelsList(newlabels) {
    ...
    let activity = `${loggedInUser.fullName} updated the label list at card-"${
      card.title
    }" at ${getNiceDate()}`;
  ...
  function addCheckList(checkList) {
    ...
    setCard(currCard);
    socket.emit('updateCard', card);
    let activity = `${loggedInUser.fullName} added a checklist at card-"${
      card.title
    }" at ${getNiceDate()}`;
    // console.log(currCard);
    updateCard(activity);
  ...
  function saveItemToCheckList(str, idx) {
    ...
    setCard(currCard);
    socket.emit('updateCard', card);
    let activity = `${loggedInUser.fullName} updated a checklist at card-"${
      card.title
    }" at ${getNiceDate()}`;
    updateCard(activity);
  }
  ...
  function deleteCheckList(checkListIdx) {
    ...
    setCard(currCard);
    socket.emit('updateCard', card);
    let activity = `${loggedInUser.fullName} deleted a checklist at card-"${
      card.title
    }" at ${getNiceDate()}`;
    updateCard(activity);
  }
  ...
  function addCover(cover, type) {
    ...
    setCard(currCard);
    socket.emit('updateCard', card);
    let activity = `${loggedInUser.fullName} added a cover at card-"${
      card.title
    }" at ${getNiceDate()}`;
    updateCard(activity);
  }
  ...
  function deleteAttachment(idx) {
    ...
    setCard(currCard);
    socket.emit('updateCard', card);
    let activity = `${loggedInUser.fullName} has deleted a link at card-"${
      card.title
    }" at ${getNiceDate()}`;
    updateCard(activity);
  }
  ...
  function addMarker(lat, lng) {
    ...
    setCard(currCard);
    let activity = `${loggedInUser.fullName} added location to a card at card-${
      card.title
    } at ${getNiceDate()}`;
    updateCard(activity);
  }
