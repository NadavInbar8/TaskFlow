...
import {Members, Labels, Checklist, Dates, Attachment, Cover} from '../cmps/detailsModals/modals.jsx';
...
export const CardDetails = () => {
	...
	function addCheckList(checkList) {
		const currCard = card;
		currCard.checkLists ? currCard.checkLists.push(checkList) : (currCard.checkLists = [checkList]);
		setCard(currCard);
		// console.log(currCard);
		updateCard();
	}
			...
			{board.groups ? (
				<div>
					...
					<section className='card-details'>
						{card.cover && (
							<section className={card.cover + '-cover' + ' ' + 'card-details-cover'}>
								<span
									onClick={() => {
										deleteCover();
									}}>
						...
						<div className='card-details-layout'>
							...
							<div className='card-details-main'>
								<div className='edit-actions'>
									<div className='date-on-details'>{card.date && <h2>Due date:{card.date}</h2>}</div>
									...
									<section className='modals-container'>
										<ul>
											...
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('member')}>
											...
											{/* /////////////////////////////////////////////////////////////////// */}
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('labels')}>
													<img className='details-svg' src={label} alt='' />
													Labels
												</span>
												{labelsModal && <Labels toggleModal={toggleModal} addLabel={addLabel} />}
											</li>
											{/* //////////////////////////////////////////////////////////////////// */}
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('checklist')}>
													<img className='details-svg' src={checklist} alt='' />
													Checklist
												</span>
												{checklistModal && <Checklist toggleModal={toggleModal} addCheckList={addCheckList} />}
											</li>
											{/* ////////////////////////////////////////////////// */}
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('dates')}>
													<img className='details-svg' src={date} alt='' />
													Dates
												</span>
												{datesModal && <Dates toggleModal={toggleModal} addDate={addDate} />}
											</li>
											{/* ///////////////////////////////////////////////////// */}
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('attachment')}>
											...
											{/* ////////////////////////////////////////////// */}
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('cover')}>
