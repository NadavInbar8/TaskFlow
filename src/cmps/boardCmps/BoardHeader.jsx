...
export const BoardHeader = ({setForceRender, filterBoard, forceRender}) => {
	...
	const toggleStarring = () => {
		...
		// setStarStatus(updatedBoard.starred);
		...
		<header className='board-header'>
			<div className='header-left-container flex-center'>
				...
				<div
					...
					{board.starred && <img className='star' src={fullStar} alt='Starred board'></img>}
					{!board.starred && <img className='star' src={whiteStar} alt='Unstarred board'></img>}
					{/* </div> */}
				</div>
