...
import { setUser, setUsers, setGuestUser } from '../store/user.action.js';
            ...
            <div className='left-container flex'>
              ...
              {location.pathname !== '/' && (
                <ul>
                  <li className='boards'>
                    <span
                      className='li-span flex-center app-header-span'
                  ...
                  <li className='create-li'>
                    <span
                      className='app-header-span'
                      onClick={() => toggleModal('createModal')}
                    >
                      Create
                    </span>
                    {modal === 'createModal' && (
                      <CreateModal loggedInUser={loggedInUser} />
                    )}
                  </li>
                </ul>
              )}
