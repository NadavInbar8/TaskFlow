...
export function Signup() {
	...
	const responseGoogle = (response) => {
		...
		const user = {
			...
			password: '11111',
			fullName: response.profileObj.givenName + ' ' + response.profileObj.familyName,
			initials:
				response.profileObj.givenName.charAt(0).toUpperCase() + response.profileObj.familyName.charAt(0).toUpperCase(),
				...
				<Container component='main' maxWidth='xs'>
					...
					<Box
						...
						<Box component='form' noValidate onSubmit={handleSubmit} sx={{mt: 3}}>
							...
							<GoogleLogin
								clientId={'1009800341332-rucoje3gjell9n316gm6fel98pp78ovp.apps.googleusercontent.com'}
