...
export const CardDetails = () => {
	...
	function deleteLabel(idx) {
		...
		let activity = {
			user: loggedInUser,
			msg: `Removed a label at card: ${card.title}`,
			time: getNiceDate(),
		};
		console.log(currCard);
		updateCard(activity);
	...
	function updateLabelsList(newlabels) {
		...
		let activity = {
			user: loggedInUser,
			msg: `Updated a label list at card: ${card.title}`,
			time: getNiceDate(),
		};
	...
	function deleteItemFromCheckList(listIdx, itemIdx) {
		...
		let activity = {
			user: loggedInUser,
			msg: `Removed an item from a checklist at card: ${card.title}`,
			time: getNiceDate(),
		};
		updateCard(activity);
	}
	...
	function deleteCheckList(checkListIdx) {
		...
		let activity = {
			user: loggedInUser,
			msg: `Removed a checklist at card: ${card.title}`,
			time: getNiceDate(),
		};
		updateCard(activity);
	}
	...
	function deleteAttachment(idx) {
		...
		let activity = {
			user: loggedInUser,
			msg: `Removed an attached image at card-${card.title}`,
			time: getNiceDate(),
		};
		updateCard(activity);
	}
	...
	function attachLink(link) {
		...
		let activity = {
			user: loggedInUser,
			msg: `Attached an image at card-${card.title}`,
			time: getNiceDate(),
		};
		updateCard(activity);
	}
	...
	function updateAttachmentName(name, idx) {
		...
		let activity = {
			user: loggedInUser,
			msg: `Updated an attachd image name at card-${card.title}`,
			time: getNiceDate(),
		};
	...
	function addUserToCard(user) {
		...
		if (currCard.users) {
			...
			if (doesUserExist) {
				...
				let activity = {
					user: loggedInUser,
					msg: ` Removed ${user.fullName} from card-${card.title}`,
					time: getNiceDate(),
				};
				...
				let activity = {
					user: loggedInUser,
					msg: `Added ${user.fullName} to card-${card.title}`,
					time: getNiceDate(),
				};
	...
	function addMarker(lat, lng) {
		...
		let activity = {
			user: loggedInUser,
			msg: ` Pined a location at card-${card.title}`,
			time: getNiceDate(),
		};
		updateCard(activity);
	}
											...
											<section className='users-section'>
												...
												<section className='users-details-section'>
													{card.users.map((user, idx) => {
														...
														return (
															<div key={idx} style={{backgroundColor: background}} className='user-details-preview'>
																{user.initials}
															</div>
														);
													})}
													<div
														...
														{modal === 'memberModalLeft' && (
															<Members users={users} addUserToCard={addUserToCard} loggedInUser={loggedInUser} />
														)}
													</div>
												</section>
											</section>
											...
											{card.date && (
												<section className='date'>
													...
													<main>
														...
														<span className='chosen-date' onClick={() => toggleModal('dateModalLeft')}>
															{card.date.date}
														</span>
														&nbsp;
									...
									<section className='modals-container'>
										<ul className='actions-list'>
											...
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('memberModal')}>
											...
											{/* /////////////////////////////////////////////////////////////////// */}
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('labelsModal')}>
											...
											{/* //////////////////////////////////////////////////////////////////// */}
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('checklistModal')}>
											...
											{/* ////////////////////////////////////////////////// */}
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('datesModal')}>
											...
											{/* ///////////////////////////////////////////////////// */}
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('attachmentModal')}>
													<img className='details-svg' src={attachment} alt='' /> Attachment
												</span>
											...
											{/* ////////////////////////////////////////////// */}
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('coverModal')}>
											...
											<li className='details-li'>
												<span className='li-span' onClick={() => setIsMapShown(!isMapShown)}>
											...
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('moveModal')}>
											...
											<li className='details-li'>
												<span className='li-span' onClick={() => toggleModal('moveModalCopy')}>
